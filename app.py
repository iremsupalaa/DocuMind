...
kat veya konum kapsamındaki toplu eşik analizi için find_meters_by_metric_threshold,
...
kat veya koordinat filtresi için find_meters_by_location,
konum gruplarının enerji sıralaması için rank_meter_locations_by_energy,
